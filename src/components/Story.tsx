    ...
    <section id="story" className="relative bg-cream py-20 md:py-28">
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 px-6 md:grid-cols-2 md:gap-16 md:px-12">
        ...
        <div className="order-1 md:order-2">
          <Reveal>
            <h2 className="mb-6 font-serif text-[28px] font-bold leading-[1.3] text-ink md:text-[32px]">
              {t.story.titleLine1}
              <br />
              {t.story.titleLine2}
            </h2>
          ...
          <Reveal delay={0.1}>
            <p className="mb-4 text-[14px] leading-[1.8] text-ink-muted">{t.story.paragraph1}</p>
          </Reveal>
          <Reveal delay={0.15}>
            <p className="mb-6 text-[14px] leading-[1.8] text-ink-muted">{t.story.paragraph2}</p>
          </Reveal>

          <Reveal delay={0.2}>
            <ul className="mb-6 space-y-3 rounded-sm border-l-[3px] border-gold bg-paper p-5">
              {t.story.highlights.map((highlight) => (
                <li key={highlight} className="flex items-start gap-2.5 text-[13px] font-medium text-ink">
          ...
          <Reveal delay={0.25}>
            <p className="text-[14px] font-semibold leading-[1.8] text-ink">{t.story.closing}</p>
          </Reveal>
        </div>
      </div>
    </section>
